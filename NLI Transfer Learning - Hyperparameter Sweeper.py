...
HF_TOKEN = config("HF_TOKEN_JALAL")
...
class TransferLearningPaper(PreTrainedModel):
    def __init__(self, configs, lambda_kld, learningrate_student, tokenizer, mbert_type, batchnorm_epsilon = 1e-5):
        super(TransferLearningPaper, self).__init__(configs)
